...
<head>
    ...
    <!-- RESOURCES -->
    <!-- Common CSS -->
	<link rel="stylesheet" href="css/styles.min.css?t=1686259036008">

	<!-- Common JS -->
	<script src="js/lib.min.js?t=1686259036008" defer></script>

    <!-- Playback / Library -->
	<!--removeIf(GENINDEXDEV)-->
    <?php if ($section == 'index') { ?>
	<!--endRemoveIf(GENINDEXDEV)-->
		<link rel="stylesheet" href="css/main.min.css?t=1686259036008">
		<script src="js/main.min.js?t=1686259036008" defer></script>
    <!-- Configs -->
	<!--removeIf(GENINDEXDEV)-->
    <?php } else { ?>
	<!--endRemoveIf(GENINDEXDEV)-->
		<!--removeIf(NOCONFIGSECTION)-->
		<script src="js/config.min.js?t=1686259036008" defer></script>
...
<body onorientationchange="javascript:location.reload(true); void 0;">
	...
	<div id="panel-header" class="ui-header ui-bar-f ui-header-fixed slidedown" data-position="fixed" data-role="header" role="banner">
		...
		<div id="config-tabs" class="viewswitch-cfgs hide">
			<a id="lib-config-btn" class="btn" href="lib-config.php"><span>音乐库</span><i class="fas fa-database"></i></a>
			<a id="snd-config-btn" class="btn" href="snd-config.php"><span>音频</span><i class="fas fa-volume-up"></i></a>
			<a id="net-config-btn" class="btn" href="net-config.php"><span>网络</span><i class="fas fa-sitemap"></i></a>
			<a id="sys-config-btn" class="btn" href="sys-config.php"><span>系统</span><i class="fas fa-cogs"></i></a>
            <a id="ren-config-btn" class="btn" href="ren-config.php"><span>渲染器</span><i class="fas fa-play-circle"></i></a>
		</div>
		...
		<div class="dropdown">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="menu-settings">
				<?php if ($section == 'index') { ?>
                    <li><a href="#configure-modal" data-toggle="modal"><i class="fas fa-cog sx"></i>系统设置</a></li>
					<li class="context-menu menu-separator"><a href="#notarget" data-cmd="preferences"><i class="fas fa-edit sx"></i>个性定制</a></li>
				...
				<?php } else { ?>
					<li class="context-menu menu-separator"><a href="#configure-modal" data-toggle="modal"><i class="fas fa-cog sx"></i>系统设置</a></li>
                    <li><a href="javascript:audioPlayback()"><i class="fas fa-music sx"></i>音频信息</a></li>
