	...
	.ready((function(t) {
		...
		null != window.ui_notify && ui_notify(), GLOBAL.scriptSection = "configs", t("#config-tabs")
			...
			.attr("content", "height=" + t(window)
				...
				SESSION.json = e.cfg_system, THEME.json = e.cfg_theme, NETWORK.json = e.cfg_network, t("#config-back, #config-home")
			...
			.click((function(e) {
				t("#multiroom-tx-adv-options")
					.toggleClass("hide");
				var o = "显示" == t("#multiroom-tx-adv-options-label")
					.html() ? "隐藏" : "显示";
				t("#multiroom-tx-adv-options-label")
					.html(o), t.post("command/multiroom.php?cmd=tx_adv_toggle", {
						adv_toggle: o
					})
			...
			.click((function(e) {
				t("#multiroom-rx-adv-options")
					.toggleClass("hide");
				var o = "显示" == t("#multiroom-rx-adv-options-label")
					.html() ? "隐藏" : "显示";
				t("#multiroom-rx-adv-options-label")
					.html(o), t.post("command/multiroom.php?cmd=rx_adv_toggle", {
						adv_toggle: o
					})
			})), t("#backup-create")
			.click((function(t) {
