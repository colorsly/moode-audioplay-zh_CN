...
<div id="about-modal" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="about-modal-label" aria-hidden="true">
	...
	<div class="modal-body">
		...
		<h5>发布信息</h5>
		<ul>
			<li>Release: 8.3.3 2023-06-08</li>
<!-- NOTE: getMoodeRel() parses this  -->
			<li>Maintainer: Tim Curtis &copy; 2014</li>
			<li>Documentation: <a class="moode-about-link target-blank-link" href="./relnotes.txt" target="_blank">View release notes,</a>&nbsp<a class="moode-about-link target-blank-link" href="./setup.txt" target="_blank">View setup guide</a>
			</li>
			<li>Contributors: <a class="moode-about-link target-blank-link" href="./CONTRIBS.html" target="_blank">View contributors</a>
			</li>
			<li>License: <a class="moode-about-link target-blank-link" href="./COPYING.html" target="_blank">View GPLv3</a>
			</li>
		</ul>
		<h5>平台信息</h5>
		<ul>
			...
			<li>Pi model: <span id="sys-hardware-rev"></span>
			</li>
...
<div id="configure-modal" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="configure-modal-label" aria-hidden="true">
	<div class="modal-header">
		<button aria-label="Close" type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		<h3 id="configure-modal-label">系统设置</h3>
	</div>
	<div class="modal-body">
		<div id="configure">
			<ul>
...
<div id="restart" class="hide">
	<div class="reconnect-bg"></div>
	<a href="javascript:location.reload(true); void 0" class="btn reconnect-btn">重新连接</a>
	<span class="reconnect-msg">系统重启</span>
</div>
<div id="shutdown" class="hide">
	<div class="reconnect-bg"></div>
	<a href="javascript:location.reload(true); void 0" class="btn reconnect-btn">重新连接</a>
	<span class="reconnect-msg">系统关机</span>
</div>
<?php
