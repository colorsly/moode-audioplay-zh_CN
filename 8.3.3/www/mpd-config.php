...
if (isset($_POST['save']) && $_POST['save'] == '1') {
	...
	submitJob('mpdcfg', $queue_args, '设置已更新', 'MPD已重启');
}
...
// Replaygain
$_mpd_select['replaygain'] .= "<option value=\"off\" " . (($cfgMPD['replaygain'] == 'off') ? "selected" : "") . " >关</option>\n";
$_mpd_select['replaygain'] .= "<option value=\"auto\" " . (($cfgMPD['replaygain'] == 'auto') ? "selected" : "") . " >自动</option>\n";
$_mpd_select['replaygain'] .= "<option value=\"album\" " . (($cfgMPD['replaygain'] == 'album') ? "selected" : "") . " >专辑</option>\n";
$_mpd_select['replaygain'] .= "<option value=\"track\" " . (($cfgMPD['replaygain'] == 'track') ? "selected" : "") . " >曲目</option>\n";
