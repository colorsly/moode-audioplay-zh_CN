...
if (isset($_POST['save']) && $_POST['save'] == '1') {
	...
	submitJob('spotifysvc', '', '设置已更新', ($_SESSION['spotifysvc'] == '1' ? 'Spotify接收器重新启动' : ''));
}
...
$_select['dither'] .= "<option value=\"none\" " . (($cfgSpotify['dither'] == 'none') ? "selected" : "") . ">无</option>\n";
...
$_select['normalization_gain_type'] .= "<option value=\"album\" " . (($cfgSpotify['normalization_gain_type'] == 'album') ? "selected" : "") . ">专辑</option>\n";
$_select['normalization_gain_type'] .= "<option value=\"track\" " . (($cfgSpotify['normalization_gain_type'] == 'track') ? "selected" : "") . ">曲目</option>\n";
