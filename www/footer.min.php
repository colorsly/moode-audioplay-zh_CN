...
<div id="about-modal" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="about-modal-label" aria-hidden="true">
	...
	<div class="modal-body">
		...
		<ul>
			...
			<li>文档: <a class="moode-about-link" href="./relnotes.txt" target="_blank">查看发行说明，</a>&nbsp<a class="moode-about-link" href="./setup.txt" target="_blank">查看设置指南</a>
			</li>
			<li>贡献者: <a class="moode-about-link" href="./CONTRIBS.html" target="_blank">查看贡献者</a>
			</li>
			<li>License: <a class="moode-about-link" href="./COPYING.html" target="_blank">查看GPLv3</a>
			</li>
		</ul>
		<h5>平台信息</h5>
		<ul>
...
<div id="power-modal" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="power-modal-label" aria-hidden="true">
	...
	<div class="modal-body">
		<button aria-label="Shutdown" id="system-shutdown" data-dismiss="modal" class="btn btn-primary btn-large btn-block">系统关机</button>
		<button aria-label="Restart" id="system-restart" data-dismiss="modal" class="btn btn-primary btn-large btn-block" style="margin-bottom:15px;">重新启动</button>
	</div>
	<div class="modal-footer">
		<button aria-label="Cancel" class="btn singleton" data-dismiss="modal" aria-hidden="true">取消</button>
	</div>
</div><!-- RECONNECT/RESTART/SHUTDOWN -->
