	...
	renderSongs = function(e) {
		...
		if (document.getElementById("songsList")
			...
			if (LIB.filters.artists.length > 0) {
				...
				if ("full_lib" != SESSION.json.library_flatlist_filter) var y = '<div id="lib-flatlist-filter"><i class="far fa-filter"></i>过滤</div>';
				else y = "";
				$("#lib-coverart-img")
...
$("#genreheader, #library-header")
	...
	.click((function(e) {
		...
		if ($("#radioview-sort-tag span")
			...
			if ("Not installed" == SESSION.json.recorder_status) var i = '<li class="modal-dropdown-text"><a href="#notarget" data-cmd="recorder-status-sel"><span class="text">未安装</span></a></li><li class="modal-dropdown-text"><a href="#notarget" data-cmd="recorder-status-sel"><span class="text">安装记录器</span></a></li>';
			else i = '<li class="modal-dropdown-text"><a href="#notarget" data-cmd="recorder-status-sel"><span class="text">开</span></a></li><li class="modal-dropdown-text"><a href="#notarget" data-cmd="recorder-status-sel"><span class="text">关</span></a></li><li class="modal-dropdown-text"><a href="#notarget" data-cmd="recorder-status-sel"><span class="text">卸载记录器</span></a></li>';
			...
			"Install recorder" == t ? $.ajax({
				...
				.text() ? (notify("recorder_tagging", "Wait until completion message appears", "infinite"), $("#tag-recordings span")
					.text("No"), $.post("command/recorder_cmd.php?cmd=recorder_tag_files", (function() {
						notify("recorder_tagged", "正在更新库...", "5_seconds")
