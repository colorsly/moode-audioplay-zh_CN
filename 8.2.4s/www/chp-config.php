...
if ($_SESSION['i2sdevice'] == 'Allo Boss 2 DAC') {
	...
	// De-emphasis filter
	$_select['boss2_deemphasis_filter'] .= "<option value=\"on\" " . (($boss2_deemphasis_filter == 'on') ? "selected" : "") . ">开</option>\n";
	$_select['boss2_deemphasis_filter'] .= "<option value=\"off\" " . (($boss2_deemphasis_filter == 'off') ? "selected" : "") . ">关</option>\n";
	// Filter speed
	...
	// High pass filter
	$_select['boss2_highpass_filter'] .= "<option value=\"on\" " . (($boss2_highpass_filter == 'on') ? "selected" : "") . ">开</option>\n";
	$_select['boss2_highpass_filter'] .= "<option value=\"off\" " . (($boss2_highpass_filter == 'off') ? "selected" : "") . ">关</option>\n";
	// Non-oversampling emulation
	$_select['boss2_nonosf_emulate'] .= "<option value=\"on\" " . (($boss2_nonosf_emulate == 'on') ? "selected" : "") . ">开</option>\n";
	$_select['boss2_nonosf_emulate'] .= "<option value=\"off\" " . (($boss2_nonosf_emulate == 'off') ? "selected" : "") . ">关</option>\n";
	// Phase compensation
	$_select['boss2_phase_compensation'] .= "<option value=\"on\" " . (($boss2_phase_compensation == 'on') ? "selected" : "") . ">开</option>\n";
	$_select['boss2_phase_compensation'] .= "<option value=\"off\" " . (($boss2_phase_compensation == 'off') ? "selected" : "") . ">关</option>\n";
